...
class ConverseResponse(BaseModel):
    ...
    base_risk_score: int | None = Field(default=None, description="综合风险分 0-100（仅 assessment 时）")
    dimensions: dict[str, int] | None = Field(default=None, description="五维评分（仅 assessment 时）")
    dominant_pattern: str | None = Field(default=None, description="主导风险模式（仅 assessment 时）")
