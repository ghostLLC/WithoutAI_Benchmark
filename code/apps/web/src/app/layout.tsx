      ...
      <body className="min-h-screen flex flex-col bg-[var(--color-bg)] text-[var(--color-text)]">
        <header className="border-b border-[var(--color-border)] bg-[var(--color-surface)]/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-4xl mx-auto px-5 h-14 flex items-center justify-between">
            <Link
              href="/"
              className="text-base font-semibold tracking-tight no-underline text-[var(--color-text)] hover:text-[var(--color-accent)] transition-colors"
            >
              WithoutAI
            </Link>
        ...
        <footer className="border-t border-[var(--color-border)] bg-[var(--color-surface)]/50">
          <div className="max-w-4xl mx-auto px-5 py-6 text-center text-xs text-[var(--color-text-tertiary)]">
